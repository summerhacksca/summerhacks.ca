			...
			<div className="flex flex-col items-start p-[12px] w-full">
				<div className="flex flex-col items-start gap-[36px] px-2 py-9 md:p-[36px] flex-1 self-stretch box-border">
					...
					<div className="flex flex-col gap-[24px] w-full">
						...
						{/* Description */}
						<p className="max-w-[372px] font-['Maison Neue',sans-serif] text-[14px] font-normal leading-normal text-white">
							We’re organizing a hackathon designed to be
							genuinely unique — by your friends at SummerHacks.
						</p>

						{/* Team Grid - Responsive: 1 col mobile, 2 cols tablet, 3 cols small desktop, 4 cols medium, 5 cols large */}
						<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-x-[8px] gap-y-[16px] md:gap-x-[32px] md:gap-y-[36px] lg:gap-x-[36px] lg:gap-y-[44px] w-full">
							{teamMembers.map((member, index) => (
								...
								>
									<div className="relative w-full aspect-square bg-[#f0f0f0] overflow-hidden">
										{member.image ? (
											...
											<div className="flex items-center justify-center size-full bg-gradient-to-br from-[#ffcf98] to-[#fdb869]">
												<p className="text-[#2a2a2a] text-[32px] font-medium">
									...
									<div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0">
										<p className="font-['Maison Neue:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-white tracking-[-0.32px]">
											{member.name}
										</p>
										<p className="font-['Maison Neue:Book',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-white tracking-[-0.28px]">
											{member.role}
										</p>
									</div>
								</div>
